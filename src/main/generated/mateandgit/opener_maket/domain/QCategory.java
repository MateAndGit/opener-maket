...
public class QCategory extends EntityPathBase<Category> {
    ...
    private static final long serialVersionUID = 269329638L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QCategory category = new QCategory("category");

    public final EnumPath<mateandgit.opener_maket.domain.status.CategoryStatus> categoryStatus = createEnum("categoryStatus", mateandgit.opener_maket.domain.status.CategoryStatus.class);
