...
public class QUserCoupon extends EntityPathBase<UserCoupon> {
    ...
    private static final long serialVersionUID = 960756153L;
    ...
    public final EnumPath<mateandgit.opener_maket.domain.status.CouponStatus> status = createEnum("status", mateandgit.opener_maket.domain.status.CouponStatus.class);
