...
public class QUser extends EntityPathBase<User> {
    ...
    private static final long serialVersionUID = 562169779L;
    ...
    public final ListPath<SellItem, QSellItem> items = this.<SellItem, QSellItem>createList("items", SellItem.class, QSellItem.class, PathInits.DIRECT2);
